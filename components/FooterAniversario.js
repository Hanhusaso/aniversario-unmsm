			...
			<div className="container mx-auto py-20 px-20 ">
				...
				<div className="text-center text-blanco">
					...
					<ul>
						...
						<li className="mb-2">Dr. Johannes Schmidt Urdanivia</li>
						<li className="mb-2">Dr. Edgar Froilan Damián Núñez</li>
						<li className="mb-2">Dr. Manuel León Núñez Vergara</li>
						<li className="mb-2">
							Representante de la Dirección General de
							Administración
						</li>
						<li className="mb-2">
							Representante de la Oficina de Secretaría General
						</li>
						<li className="mb-2">
...
export default FooterAniversario;
